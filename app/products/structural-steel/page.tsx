...
import { Hammer, Ruler, Zap, Wrench, ShieldCheck, Download } from "lucide-react";

// 1. DUMMY DATA FOR STRUCTURAL STEEL
const productData = {
  title: "Structural Steel Sections (IS2062 Grade)",
  tagline: "The Foundation of Modern Infrastructure and Construction.",
  heroImage: "/product/StructuralStee.png", // Use the same image as featured card
  fullDescription: "Our structural steel products, compliant with BIS IS2062 standards, are the backbone of large-scale construction. We ensure strict dimensional tolerances and superior weldability, providing maximum structural integrity for buildings, bridges, and heavy machinery frames. Available in high-grade angles, channels, and various beam sizes.",
};

const technicalSpecs = [
  { spec: "Standard Grade", value: "IS 2062 E250 / E350", emphasis: true },
  { spec: "Material", value: "Mild Steel, Low Carbon Alloy" },
  { spec: "Weldability", value: "Excellent" },
  { spec: "Tensile Strength (min)", value: "410 MPa (for E250)" },
  { spec: "Yield Strength (min)", value: "250 MPa (for E250)" },
];

const availableSections = [
  { icon: Wrench, type: "ISA Angles", sizes: "50x50x5 mm to 200x200x25 mm" },
  { icon: Hammer, type: "ISMC Channels", sizes: "75x40 mm to 400x100 mm" },
  { icon: Zap, type: "I Beams (ISMB)", sizes: "100 mm to 600 mm series" },
];
    ...
    <div className="w-full">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-3 gap-10">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              Certified to **Bureau of Indian Standards (BIS) IS 2062**, ensuring superior physical properties and chemical composition for demanding construction projects.
            </p>
          </motion.div>
      ...
      <section className="py-16 md:py-20 bg-white dark:bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          >
            Available Sections & Standard Sizes
          </motion.h2>
            ...
            {availableSections.map((section, index) => (
              ...
              >
                ...
                <p className="text-gray-700 dark:text-gray-400 text-sm">
                  <span className="font-medium text-red-600">Standard Range:</span> {section.sizes}
                </p>
              </motion.div>
            ))}
          </div>
